...
export const projects: Project[] = [
  ...
  },
  {
    ...
    roleDe: 'Entwickler',
    links: [{ label: 'GitHub', url: 'https://github.com/burnoutberni/WikiCollab' }, { label: 'Demo', url: 'https://wikicollab.toolforge.org' }],
...
export const translations = {
  ...
  de: {
    ...
    mediaPlayer: {
      open: 'Medienplayer öffnen',
      close: 'Medienplayer einklappen',
      media: 'Medien',
      loading: 'Medien werden geladen',
      retry: 'Medien erneut laden',
      previous: 'Vorheriges Medium',
      next: 'Nächstes Medium',
      play: 'Medium abspielen',
      playWithSound: 'Mit Ton abspielen',
      pause: 'Medium pausieren',
      mute: 'Medium stummschalten',
      unmute: 'Medium mit Ton abspielen',
      fromThisNote: 'Aus dieser Notiz',
